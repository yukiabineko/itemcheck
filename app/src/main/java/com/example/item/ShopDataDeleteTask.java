...
public class ShopDataDeleteTask extends AsyncTask<String, Void, StringBuilder> {

    private Activity mActivity;


    public ShopDataDeleteTask(Activity activity) {
        mActivity = activity;
    }
    ...
    protected StringBuilder doInBackground(String... params) {
        ...
        // 使用するサーバーのURLに合わせる
        String urlSt = "http://yukiabineko.sakura.ne.jp/items/shopDelete.php";
